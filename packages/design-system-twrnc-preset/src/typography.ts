...
export const typographyTailwindConfig: TypographyTailwindConfigProps = {
  ...
  fontFamily: {
    ...
    'accent-regular': 'Oswald-Regular',
    'accent-medium': 'Oswald-Medium',
    'accent-bold': 'Oswald-SemiBold',
    'hero-regular': 'Oswald-Regular',
    'hero-medium': 'Oswald-Medium',
    'hero-bold': 'Oswald-SemiBold',
  },
  letterSpacing: {
