...
export const typographyTailwindConfig: TypographyTailwindConfigProps = {
  ...
  fontFamily: {
    centrano1: 'CentraNo1-Book',
    'centrano1-regular': 'CentraNo1-Book',
    'centrano1-regular-italic': 'CentraNo1-BookItalic',
    'centrano1-medium': 'CentraNo1-Medium',
    'centrano1-medium-italic': 'CentraNo1-MediumItalic',
    'centrano1-bold': 'CentraNo1-Bold',
    'centrano1-bold-italic': 'CentraNo1-BoldItalic',
    mmsans: 'MMSans-Regular',
    'mmsans-regular': 'MMSans-Regular',
    'mmsans-medium': 'MMSans-Medium',
    'mmsans-bold': 'MMSans-Bold',
    mmpoly: 'MMPoly-Regular',
    'mmpoly-regular': 'MMPoly-Regular',
  },
  letterSpacing: {
