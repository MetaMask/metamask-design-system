...
Migrating from `ui/components/component-library/checkbox` in MetaMask Extension? See the [Checkbox Migration Guide](../../MIGRATION.md#checkbox-component) for prop mappings, before/after examples, and breaking changes.
