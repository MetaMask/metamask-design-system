...
<Checkbox label="Enable notifications" isSelected={isSelected} onChange={() => setIsSelected(!isSelected)} />;
```
...
<Checkbox label="Check me" isSelected={isSelected} onChange={() => setIsSelected(!isSelected)} />
```
