...
describe('Button', () => {
  ...
  // Merged class list: tailwind-merge v3 drops `focus-visible:outline` when paired with
  // outline-none + outline-2 (see a72c63ac86306296b2e7abb17abc0d565c278f55 and follow-up PR).
