...
export const ButtonHero = forwardRef<HTMLButtonElement, ButtonHeroProps>(
  ({ className, isDisabled, isLoading, ...props }, ref) => {
    ...
    const mergedClassName = twMerge(
      ...
      // eslint-disable-next-line better-tailwindcss/no-conflicting-classes -- Redundant outline+outline-2 kept for Chromatic baseline; remove in follow-up (a72c63ac)
