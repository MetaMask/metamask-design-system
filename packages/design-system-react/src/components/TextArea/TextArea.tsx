...
export const TextArea = forwardRef<HTMLDivElement, TextAreaProps>(
  (
    ...
    const containerClassName = twMerge(
      'flex min-h-24 rounded-lg border bg-muted transition-colors',
    ...
    const textareaClassName = twMerge(
      'm-0 min-h-[88px] w-full flex-1 self-stretch border-0 bg-transparent px-4 py-3 text-default outline-none',
