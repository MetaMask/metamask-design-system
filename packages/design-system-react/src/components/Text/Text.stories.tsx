...
export const OverflowWrapStory: Story = {
  render: () => (
    <div className="border-warning-default w-48 border">
...
export const Ellipsis: Story = {
  render: () => (
    <div className="border-primary-default w-48 border">
...
export const AsChild: Story = {
  render: () => (
    <div className="space-y-4">
      ...
      <Text asChild className="border-default bg-default border">
        <input
          type="text"
