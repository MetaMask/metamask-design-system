...
<Canvas of={InputStories.IsStateStylesDisabled} />
...
For API mappings, breaking changes, and before/after examples from the Extension `component-library` `input` module, see the [Migration Guide](https://github.com/MetaMask/metamask-design-system/blob/main/packages/design-system-react/MIGRATION.md#input-component).
