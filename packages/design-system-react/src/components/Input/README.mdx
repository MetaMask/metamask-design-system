...
Migrating from `ui/components/component-library/input` in MetaMask Extension? See the [Input Migration Guide](../../MIGRATION.md#input-component) for prop mappings, before/after examples, and breaking changes.
