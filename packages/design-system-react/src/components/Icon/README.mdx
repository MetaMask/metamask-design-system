...
For extension-to-MMDS API mappings, breaking changes, and before/after examples, see the [Migration Guide](https://github.com/MetaMask/metamask-design-system/blob/main/packages/design-system-react/MIGRATION.md#icon-component).
