...
> **Note:** The `icons/` folder in this directory is auto-generated. The source of truth for all SVG assets is `packages/design-system-shared/src/assets/icons/`. Run `yarn generate:icons` from the repo root to regenerate.
...
For detailed migration instructions from the Extension component-library, see the [Migration Guide](https://github.com/MetaMask/metamask-design-system/blob/main/packages/design-system-react/MIGRATION.md#icon-component).
