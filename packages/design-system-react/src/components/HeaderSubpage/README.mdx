...
Optional title (string or node). When a string is provided, default text styling is applied: BodyMd, Medium, TextDefault. Use `titleEndAccessory` to render a badge or other accessory beside the title.
...
<HeaderSubpage
  title="Ethereum"
  description="ETH"
  descriptionProps={{ 'data-testid': 'header-description' }}
/>
```
