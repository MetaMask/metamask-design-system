        ...
        <Box className="flex flex-wrap gap-4">
          <Box className="flex flex-col gap-2">
            ...
            <Box className="flex items-center gap-2">
              <Blockies address={ethereumAddress} size={48} />
          ...
          <Box className="flex flex-col gap-2">
            ...
            <Box className="flex items-center gap-2">
              <Blockies address={bitcoinAddress} size={48} />
              <Text variant={TextVariant.BodyXs} className="font-mono">
          ...
          <Box className="flex flex-col gap-2">
            ...
            <Box className="flex items-center gap-2">
              <Blockies address={solanaAddress} size={48} />
              <Text variant={TextVariant.BodyXs} className="font-mono">
        ...
        <Box className="flex flex-wrap gap-4">
          <Box className="flex flex-col gap-2">
            ...
            <Box className="flex gap-2">
              ...
              <Box className="flex flex-col items-center gap-1">
                <Blockies address={`eip155:1:${ethereumAddress}`} size={48} />
                <Text variant={TextVariant.BodyXs} className="font-mono">
              ...
              <Box className="flex flex-col items-center gap-1">
                <Blockies address={`eip155:137:${ethereumAddress}`} size={48} />
                <Text variant={TextVariant.BodyXs} className="font-mono">
