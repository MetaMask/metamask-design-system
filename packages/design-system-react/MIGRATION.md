...
Typical component usage does not need a code change. Keep importing these names from `@metamask/design-system-react`:
...
- Public imports from `@metamask/design-system-react` continue to work unchanged.
...
Typical component usage does not need a code change. Keep importing the same names from `@metamask/design-system-react`:
