...
/**
 * React Native Code Connect template for AvatarAccount (Template API).
 *
...
export default {
  id: 'AvatarAccount',
  imports: [
    "import { AvatarAccount, AvatarAccountSize, AvatarAccountVariant } from '@metamask/design-system-react-native';",
  ],
