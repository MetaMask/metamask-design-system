...
describe('Checkbox', () => {
    ...
    expect(styles).toStrictEqual(
      expect.arrayContaining([
        expect.objectContaining(
          tw`flex size-[22px] items-center justify-center rounded-full border-2 border-error-default bg-transparent`,
        ),
      ]),
    );
  });
  ...
  it('applies selected container styles', () => {
    ...
    expect(styles).toStrictEqual(
      expect.arrayContaining([
        expect.objectContaining(
          tw`flex size-[22px] items-center justify-center rounded-full border-2 border-icon-default bg-icon-default`,
        ),
      ]),
    );
  });
  ...
  it('applies pressed container styles', () => {
    ...
    expect(styles).toStrictEqual(
      expect.arrayContaining([
        expect.objectContaining(
          tw`flex size-[22px] items-center justify-center rounded-full border-2 border-default bg-pressed`,
        ),
      ]),
    );
  });
