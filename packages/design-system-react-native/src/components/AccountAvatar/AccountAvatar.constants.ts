import { AccountAvatarSize } from '@metamask/design-system-shared';

export const MAP_AVATARACCOUNT_SIZE_SIZENUMBER: Record<
  AccountAvatarSize,
  number
> = {
  [AccountAvatarSize.Xs]: 16,
  [AccountAvatarSize.Sm]: 24,
  [AccountAvatarSize.Md]: 32,
  [AccountAvatarSize.Lg]: 40,
  [AccountAvatarSize.Xl]: 48,
};
