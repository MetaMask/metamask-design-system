...
describe('ButtonIcon', () => {
  it('renders default state correctly', () => {
    ...
    const expected = tw`items-center justify-center ${TWCLASSMAP_BUTTONICON_SIZE_DIMENSION[ButtonIconSize.Md]} bg-transparent rounded-sm opacity-100`;
  ...
  it('applies isDisabled state', () => {
    const { result } = renderHook(() => useTailwind());
    const tw = result.current;
    const expected = tw`items-center justify-center ${TWCLASSMAP_BUTTONICON_SIZE_DIMENSION[ButtonIconSize.Md]} bg-transparent rounded-sm opacity-50`;
  ...
  it('forwards style and twClassName', () => {
    const { result } = renderHook(() => useTailwind());
    const tw = result.current;
    const expected = tw`items-center justify-center ${TWCLASSMAP_BUTTONICON_SIZE_DIMENSION[ButtonIconSize.Md]} bg-transparent rounded-sm text-primary-default opacity-100`;
