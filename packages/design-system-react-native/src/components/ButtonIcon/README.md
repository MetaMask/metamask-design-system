...
The visual variant of the button. Use `ButtonIconVariant.Default` for transparent with default icon color, `ButtonIconVariant.Filled` for muted background, or `ButtonIconVariant.Floating` for the floating/contained style.
