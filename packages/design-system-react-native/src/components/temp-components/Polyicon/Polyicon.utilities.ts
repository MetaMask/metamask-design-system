...
/**
 * Builds a full <svg> string containing the Polyicon shapes.
 *
 * @param seed The seed value used to generate the icon
 * @param size The size of the SVG icon in pixels
 * @returns An SVG string representing the Polyicon
 */
export function createPolyiconSVG(seed: number | number[], size = 100): string {
...
// /////////////////////////////////////////////////////
// Polyicon SVG Creation and Caching
// /////////////////////////////////////////////////////
 ...
 *
 * @param address The address to generate the Polyicon for
 * @param size The size of the icon in pixels
 * @returns A promise that resolves to an SVG string
 */
export async function getPolyiconSVG(
  address: string,
  size: number,
): Promise<string> {
  ...
  const svgString = createPolyiconSVG(seed, size);
