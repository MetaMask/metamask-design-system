...
const meta: Meta<PolyiconProps> = {
  title: 'Temp Components/Polyicon',
  component: Polyicon,
  argTypes: {
    size: {
      control: 'number',
...
export default meta;
type Story = StoryObj<PolyiconProps>;
          ...
          >
            {sampleAccountAddresses.map((address) => (
              <Box key={address} alignItems={BoxAlignItems.Center} gap={2}>
                <Polyicon address={address} size={48} />
          ...
          >
            <Box gap={2}>
              ...
              <Box
                ...
                gap={2}
              >
                <Polyicon address={ethereumAddress} size={48} />
            ...
            <Box gap={2}>
              ...
              <Box
                ...
                gap={2}
              >
                <Polyicon address={bitcoinAddress} size={48} />
                <Text variant={TextVariant.BodyXs}>
            ...
            <Box gap={2}>
              ...
              <Box
                ...
                gap={2}
              >
                <Polyicon address={solanaAddress} size={48} />
                <Text variant={TextVariant.BodyXs}>
          ...
          <Box gap={4}>
            <Box gap={2}>
              ...
              >
                ...
                <Box alignItems={BoxAlignItems.Center} gap={1}>
                  <Polyicon address={`eip155:1:${ethereumAddress}`} size={48} />
                  <Text variant={TextVariant.BodyXs}>
...
export const Size: Story = {
  render: () => (
    <Box
      ...
      gap={4}
    >
      <Polyicon address={sampleAccountAddresses[0]} size={16} />
      <Polyicon address={sampleAccountAddresses[1]} size={24} />
      <Polyicon address={sampleAccountAddresses[2]} size={32} />
      <Polyicon address={sampleAccountAddresses[3]} size={48} />
      <Polyicon address={sampleAccountAddresses[4]} size={64} />
    </Box>
  ),
};
