 ...
 *   placeholder function in Dev Mode. Children match Storybook composition
 *   instead (Header + content + Footer).
 ...
 * - Figma `hasKeyboard` is a visual preview variant only and is not mapped.
