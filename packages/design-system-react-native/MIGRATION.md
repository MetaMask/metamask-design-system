...
- [Version Updates](#version-updates)
  - [From version 0.20.0 to 0.21.0](#from-version-0200-to-0210)
...
Normal usage does not need to change:

```tsx
// Before (0.20.0)
import { BadgeIcon, IconName } from '@metamask/design-system-react-native';

<BadgeIcon iconName={IconName.Snaps} />;
...
- Typical component usage is unchanged.
- If you referenced internal `BadgeIcon` prop types directly, re-check any assumptions tied to local-only type definitions.
