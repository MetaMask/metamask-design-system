...
| `style?: StyleProp<ViewStyle>`         | `style?: PressableProps['style']`         | type widened                                        | MMDS `style` supports both style objects and callback style functions                      |
| `label?: string \| ReactNode`          | `label?: string \| ReactNode`             | unchanged                                           | still supported                                                                            |
| not available                          | `labelProps?: Omit<Partial<TextProps>, 'children'>` | added in MMDS                                 | customize label typography without wrapping `label` manually                               |
