...
- Updated `Checkbox` selected state from primary blue to monochromatic icon colors (`bg-icon-default` / `border-icon-default` with `IconColor.IconInverse` checkmark), matching `ButtonFilter` active treatment ([#1426](https://github.com/MetaMask/metamask-design-system/pull/1426))
