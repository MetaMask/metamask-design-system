import{r as p,j as d}from"./iframe-BknD6R0A.js";import{t as c}from"./tw-merge-B12XlTeZ.js";import{B as h}from"./ButtonBase-DbNzlsEJ.js";const a=p.forwardRef(({className:i,isDanger:t,isInverse:n,isDisabled:o,isLoading:e,...s},r)=>{const l=c(!t&&!n&&["bg-transparent text-primary-default",e&&"bg-pressed"],t&&!n&&["bg-transparent text-error-default",e&&"bg-error-muted-pressed text-error-default-pressed"],n&&!t&&["bg-transparent text-primary-inverse",e&&"bg-pressed"],n&&t&&["bg-default text-error-default",e&&"bg-default-pressed"],!(o??e)&&["hover:bg-hover","active:bg-pressed",n&&t&&["hover:bg-default-hover","active:bg-default-pressed"],t&&!n&&["hover:bg-error-muted-hover","active:bg-error-muted-pressed"]],e&&"cursor-not-allowed",o&&!e&&["opacity-50","cursor-not-allowed"],i);return d.jsx(h,{ref:r,className:l,isDisabled:o,isLoading:e,...s})});a.displayName="ButtonTertiary";a.__docgenInfo={description:"",methods:[],displayName:"ButtonTertiary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Required prop for the content to be rendered within the ButtonBase"},className:{required:!1,tsType:{name:"string"},description:`Optional prop for additional CSS classes to be applied to the ButtonBase component.
