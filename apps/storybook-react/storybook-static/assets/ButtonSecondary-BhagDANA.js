import{r as p,j as d}from"./iframe-BknD6R0A.js";import{t as c}from"./tw-merge-B12XlTeZ.js";import{B as h}from"./ButtonBase-DbNzlsEJ.js";const a=p.forwardRef(({className:i,isDanger:e,isInverse:t,isDisabled:o,isLoading:n,...r},s)=>{const l=c(!e&&!t&&["bg-transparent border-2 border-icon-muted text-default",n&&"bg-pressed"],e&&!t&&["bg-transparent border-2 border-error-default text-error-default",n&&"bg-error-muted-pressed text-error-default-pressed"],t&&!e&&["bg-transparent border-2 border-primary-inverse text-primary-inverse",n&&"bg-pressed"],t&&e&&["border-0 bg-default text-error-default",n&&"bg-default-pressed"],!(o??n)&&[!e&&!t&&["hover:bg-hover","active:bg-pressed"],e&&!t&&["hover:bg-error-muted-hover","active:bg-error-muted-pressed"],t&&!e&&["hover:bg-hover","active:bg-pressed"],t&&e&&["hover:bg-default-hover","active:bg-default-pressed"]],n&&"cursor-not-allowed",o&&!n&&["opacity-50","cursor-not-allowed"],i);return d.jsx(h,{ref:s,className:l,isDisabled:o,isLoading:n,...r})});a.displayName="ButtonSecondary";a.__docgenInfo={description:"",methods:[],displayName:"ButtonSecondary",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Required prop for the content to be rendered within the ButtonBase"},className:{required:!1,tsType:{name:"string"},description:`Optional prop for additional CSS classes to be applied to the ButtonBase component.
...
@default false`},isInverse:{required:!1,tsType:{name:"boolean"},description:`Optional prop that when true, applies inverse styling to the button
