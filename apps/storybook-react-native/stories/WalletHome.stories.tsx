...
const WalletHome: React.FC = () => {
  ...
  return (
    <ScrollView style={tw`bg-default flex-1`}>
      {/* Container */}
      <View style={tw`bg-default w-full py-4`}>
        {/* Header */}
        <View style={tw`border-muted border-b px-4 py-4`}>
        ...
        <View style={tw`flex-row gap-3 px-4 py-4`}>
          <ButtonBase
            twClassName="bg-muted h-20 flex-1 rounded-lg px-0 py-4"
            contentContainerProps={{
              twClassName: 'flex-col items-center gap-y-2',
            }}
          >
        ...
        {/* Tabs */}
        <View style={tw`border-muted border-b px-4`}>
