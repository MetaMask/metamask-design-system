...
const WalletHome: React.FC = () => {
  ...
  return (
    <ScrollView style={tw`bg-background-default flex-1`}>
      {/* Container */}
      <Box twClassName="bg-background-default w-full py-4">
        {/* Header */}
        <Box twClassName="border-border-muted border-b px-4 py-4">
          <Box
        ...
        {/* Tabs */}
        <Box twClassName="border-border-muted border-b px-4">
